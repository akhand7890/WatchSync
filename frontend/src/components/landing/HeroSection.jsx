    ...
    <section className="relative min-h-[90vh] flex flex-col items-center justify-center px-4 overflow-hidden hero-mesh noise-overlay">
      ...
      >
        ...
        >
          ...
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#ff5451] via-[#ffb3ad] to-[#d0bcff]">
        ...
        >
          Watch YouTube videos with remote friends and teams with sub-second synchronization.
          Powered by WebSockets, persistent rooms, and a dark glassmorphic media interface.
        </motion.p>
