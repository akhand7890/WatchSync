  ...
  return (
    <nav className="fixed top-0 w-full z-50 flex justify-between items-center px-6 py-4 bg-[#131315]/60 backdrop-blur-md border-b border-[#5b403e]/20 shadow-sm">
      ...
      <div className="flex items-center gap-3">
        <img src="/favicon.svg" alt="WatchSync Logo" className="w-8 h-8 drop-shadow-[0_0_8px_rgba(255,84,81,0.5)]" />
        <span className="font-[Geist,sans-serif] text-2xl font-bold text-[#ffb3ad] tracking-tight">
          WatchSync
        </span>
        <span className="hidden sm:inline-block px-2.5 py-0.5 text-[11px] font-semibold text-[#d0bcff] bg-[#571bc1]/20 border border-[#d0bcff]/30 rounded-full font-[Geist,sans-serif]">
          by Akhand
        </span>
      </div>
      ...
      <div className="hidden md:flex items-center gap-8">
        ...
        <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="text-[14px] font-medium text-[#e4beba] hover:text-[#ffb3ad] transition-colors duration-200">
          GitHub
        </a>
      </div>
