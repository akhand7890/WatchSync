import { Play, Trash2, ArrowUp, ArrowDown, Sparkles, ThumbsUp } from 'lucide-react'
import { motion, AnimatePresence } from 'framer-motion'
import { useRoomContext } from '../../context/RoomContext'
import { useSocketContext } from '../../context/SocketContext'
import { emitQueueRemove, emitQueueClear, emitQueueReorder, emitChangeVideo, emitQueueUpvote } from '../../services/socketService'
            ...
            return (
              ...
              >
                ...
                <button
                  ...
                  className={`flex items-center gap-1 px-2 py-1 rounded-md text-[11px] font-bold transition-all border ${
                    item.upvotes?.includes(socket?.id)
                      ? 'bg-[#ff5451]/20 border-[#ff5451] text-[#ff5451]'
                      : 'bg-[#201f22] border-[#5b403e]/30 text-[#e4beba] hover:border-[#ffb3ad]'
                  }`}
                  title="Upvote to play sooner!"
                >
